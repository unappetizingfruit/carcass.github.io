...
let blogName = "Universal Collaple";
let authorName = "Albert Solomon";
let authorLink = "https://t.me/unappetizinggg"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
let headerHTML = '<ul> <li><a href="' + relativePath + '/index.html">UNIVERSAL COLLAPLE</a></li>' + 
'<li><a href="' + relativePath + '/archive.html">RAW, UNFILTERED ARCHIVE</a></li>' +
...
let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://neocities.org/'>Neocities!</a> since 2024</p>";
